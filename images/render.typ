...
#pagebreak()
#align(center + horizon, whiskers(size: sz))
#pagebreak()
#align(center + horizon, barkley(size: sz))
#pagebreak()
#align(center + horizon, bamboo(size: sz))
#pagebreak()
#align(center + horizon, trunks(size: sz))
#pagebreak()
#align(center + horizon, clover(size: sz))
